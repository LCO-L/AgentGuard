...
(function () {
  ...
  *{ box-sizing:border-box; font-family:'Pretendard',-apple-system,BlinkMacSystemFont,system-ui,sans-serif; }
  ...
  .hd{ background:linear-gradient(135deg,#5B5BD6,#7C6BF0); color:#fff; padding:16px 18px;
  ...
  .m.user{ background:#5B5BD6; color:#fff; align-self:flex-end; border-bottom-right-radius:4px; }
  ...
  .eng{ font-size:11px; color:#5B5BD6; padding:0 15px 10px; font-weight:700; }
  /* 빠른 액션 */
  ...
  .inbar .send{ background:#5B5BD6; border:0; color:#fff; width:40px; height:40px; border-radius:11px; cursor:pointer; font-size:16px; flex:0 0 auto; }
