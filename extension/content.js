...
(function () {
  ...
  function showError(e) { openPanel(); panel.innerHTML = '<div class="bar"><span>🛡️ AgentGuard</span><button class="x">×</button></div><div class="msg">검사에 실패했어요: ' + esc(e) + '<br><br>백엔드(설정의 서버 주소)가 실행 중인지 확인하세요.</div>'; bindClose(); }
